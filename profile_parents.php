...
// Define initial parent profile information
$parentProfile = array(
    'fullName' => 'Jane Doe',
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save'])) {
    // Retrieve form data and update parent profile
    ...
    // Store updated parent profile in session
...
// Retrieve parent profile data from session (if available)
