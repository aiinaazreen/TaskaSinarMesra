...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        $sql = "SELECT * FROM parent WHERE email = ? LIMIT 1"; // Limit 1 because username should be unique
...
<body>
        ...
        <p>Don't have an account? <a href="parent_registration.php">Register</a></p>
        </form>
</body>
</html>
